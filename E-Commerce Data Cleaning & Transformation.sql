المشروع: تنظيف وتحويل بيانات التجارة الإلكترونية
المؤلف: عبد الله ناصف
الوصف:
يقوم هذا البرنامج النصي بتنظيف شامل للبيانات على البيانات الأولية للتجارة الإلكترونية.
وهي تركز على معالجة القيم الفارغة، وتصحيح أنواع البيانات، وتصفية البيانات غير الصحيحة
المعاملات، و توحيد الأعمدة التصنيفية من أجل التحليل النهائي.
===============================================================================
-------------------------------------------------------------------------------
-- الخطوة 1: الاستكشاف الأولي للبيانات
---------------------------------------------------------------------------------01
استخدم ناصف
اختر
أعلى(100) *
...
SELECT اسم_العمود، نوع_البيانات، الحد_الأقصى_لطول_الحرف
...
اختر أفضل 100
الكمية كما في [النص الأصلي]،
الكمية_الرقمية كـ[الرقم_المُنقح]
من [dataEcommerce_Cl]
حيث quantity_numerical ليست قيمة NULL؛
...
الكمية_الرقمية كـ[الرقم_المُنقح]
من [dataEcommerce_Cl]
حيث quantity_numerical تكون NULL؛
--11 تجربة العمليات
...
من [dataEcommerce_Cl]
WHERE ISNUMERIC(UnitPrice) = 0;
--103 تعديل الجدول و اضافة عمود جديد للقيم الرقمية لل UnitPriceالمشروع: تنظيف وتحويل بيانات التجارة الإلكترونية
المؤلف: عبد الله ناصف
الوصف: 
يقوم هذا البرنامج النصي بتنظيف شامل للبيانات على البيانات الأولية للتجارة الإلكترونية. 
وهي تركز على معالجة القيم الفارغة، وتصحيح أنواع البيانات، وتصفية البيانات غير الصحيحة 
...
من [dataEcommerce_Cl]
WHERE ISNUMERIC(UnitPrice) = 0;
--103 تعديل الجدول و اضافة عمود جديد للقيم الرقمية لل UnitPricPROJECT: E-Commerce Data Cleaning & Transformation
